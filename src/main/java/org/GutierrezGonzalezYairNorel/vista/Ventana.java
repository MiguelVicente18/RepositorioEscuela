...
public class Ventana extends JFrame implements Ejecutable {
    ...
    private enum FiguraType {
        CUADRADO("Cuadrado", 1),
        CIRCULO("Circulo", 1),
        POLIGONO_REGULAR("Poligono Regular de n lados", 2),
    ...
    private void init() {
        ...
        comboFigura = new JComboBox<>(new String[]{
                ...
                FiguraType.POLIGONO_REGULAR.getNombre(),
    ...
    private String[] getEtiquetas(FiguraType tipo) {
        switch (tipo) {
            ...
            case POLIGONO_REGULAR:
                return new String[]{"Lado:", "Número de lados"};
            case RECTANGULO:
    ...
    private Figura crearFigura(FiguraType tipo) {
        switch (tipo) {
            ...
            case POLIGONO_REGULAR:
                return new PoligonoRegular(Double.parseDouble(textFields[0].getText()),
