...
public class Menu
{
    ...
    {
        System.out.println("BIENVENIDO A LA CÁLCULADORA DE ÁREAS Y PERÍMETROS");
        System.out.println("PROGRAMA DE FIGURAS");
        System.out.println("SELECCIONA EL NUMERO DE LA OPCION QUE DESEAS");
        ...
        System.out.println("6.- Polígono regular de n lados ");
    ...
    public static void leenLados( ){ System.out.println( "Dame el número de lados");}
}
